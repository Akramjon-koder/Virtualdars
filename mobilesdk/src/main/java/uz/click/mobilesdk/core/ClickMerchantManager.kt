        ...
        okClient.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                if (response.isSuccessful) {
                    ...
                    response.body?.let {
                        val initialResponse =
                            moshi.adapter<InitialResponse>(InitialResponse::class.java)
                                .fromJson(it.string())
                ...
                if (response.isSuccessful) {
                    ...
                    response.body?.let {
                        val checkoutResponse =
                            moshi.adapter<CheckoutResponse>(CheckoutResponse::class.java)
                                .fromJson(it.string())
    ...
    fun checkPaymentByRequestId(requestId: String, listener: ResponseListener<CheckoutResponse>) {
        ...
        okClient.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                response.body?.let {
                   // Log.e("responsebody",it.string())
                    if (response.isSuccessful) {

                        val checkoutResponse =
                            moshi.adapter(CheckoutResponse::class.java)
                                .fromJson(it.string())
                        Log.e("responsebody",it.string())
            ...
            override fun onResponse(call: Call, response: Response) {
                if (response.isSuccessful) {
                    ...
                    response.body?.let {
                        ...
                        val invoiceResponse =
                            moshi.adapter<InvoiceResponse>(InvoiceResponse::class.java)
                                .fromJson(it.string())
